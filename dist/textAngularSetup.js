...
angular.module('textAngularSetup', ["ngMaterial"])
...
taRegisterTool('insertImage', {
  ...
  action: function(){
    $mdDialog.show({
      ...
      templateUrl: 'views/pages/insertImage.tmpl.html',
    ...
    function DialogController($scope, $mdDialog, $timeout, $filter, Medium) {

      Medium.getAllMediaForPage()
      ...
      $scope.getMediaByPage = function (pageNumber) {
        Medium.getMediaByPage(pageNumber)
        .then((function(response) {
          var data = response.data.data;
          var error = response.data.errors;
          if(error === undefined && data !== null) {
      ...
      $scope.getImageUrl = function(id) {
        ...
        if (!blockJavascript(id)) {
          ...
          // var imgTag = '<img src="' +  + '"'
          // var embed = ' <p class="displayNone">.<br/></p> <media id="'+ id + '"></media> <p class="displayNone">.<br/></p> <p><br></p>';
          var embed = ' <p class="displayNone">.<br/></p> <media id="'+ id + '"></media> <p class="displayNone">.<br/></p> <p><br></p>';
